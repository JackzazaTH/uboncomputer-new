...
import { 
  ...
  Home, Building, Newspaper, Phone, Info as InfoIcon, Printer
} from 'lucide-react';
...
const Header: React.FC<HeaderProps> = ({ onSearchSubmit, onNavigate, onAuthClick, currentPage, topBarText, allProducts }) => {
  ...
  const dropdownCategories = [
    ...
    { name: 'คอมพิวเตอร์ตั้งโต๊ะ', icon: <Computer size={20} className="text-gray-500"/>, page: 'desktopComputer' as Page },
    { name: 'คอมพิวเตอร์ AIO', icon: <Monitor size={20} className="text-gray-500"/>, page: 'aioComputer' as Page },
    { name: 'ปริ้นเตอร์', icon: <Printer size={20} className="text-gray-500"/>, page: 'printer' as Page },
