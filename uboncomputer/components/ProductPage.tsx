...
import { ShoppingCart, CheckCircle, ShieldCheck, Truck, Plus, Minus, XCircle, GitCompare } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-4 items-center">
              <button onClick={handleAddToCart} className="flex-grow sm:flex-grow-0 flex items-center justify-center bg-orange-600 text-white font-bold py-3 px-8 rounded-lg hover:bg-orange-700 transition-colors">
