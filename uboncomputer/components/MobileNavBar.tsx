...
const MobileNavBar: React.FC<MobileNavBarProps> = ({ onNavigate, currentPage, onAuthClick }) => {
  ...
  return (
    <>
      <nav className="lg:hidden fixed bottom-0 left-0 right-0 bg-white z-50 border-t border-gray-200 shadow-[0_-2px_10px_rgba(0,0,0,0.05)]">
        <div className="container mx-auto px-2 max-w-md">
          <div className="flex justify-around items-center h-20">
            {navItems.map((item) => {
              ...
              const activeClasses = isCurrent ? 'text-orange-600 font-bold' : 'text-gray-500 hover:text-orange-500';
