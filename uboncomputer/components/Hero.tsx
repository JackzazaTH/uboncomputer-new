        ...
        <div className="flex flex-col justify-center h-full text-white w-full md:w-3/4 lg:w-2/3 xl:w-1/2 pb-12 md:pb-0">
            <div className="space-y-4 sm:space-y-6 animate-slide-in-up">
              <h1 className="text-4xl sm:text-5xl md:text-6xl 2xl:text-7xl font-extrabold tracking-tight leading-[1.1] drop-shadow-2xl">
                  <span className="block text-transparent bg-clip-text bg-gradient-to-r from-white to-gray-300 filter drop-shadow-lg">{slides[currentIndex].titleLine1}</span>
                  <span className="block text-orange-500 filter drop-shadow-lg">{slides[currentIndex].titleLine2}</span>
                  <span className="block text-transparent bg-clip-text bg-gradient-to-r from-gray-100 to-gray-400 text-3xl sm:text-4xl md:text-5xl mt-2">{slides[currentIndex].titleLine3}</span>
              </h1>
             <div className="mt-8 sm:mt-10 flex flex-wrap gap-4">
               <a
                href="#products"
                className="inline-flex items-center bg-orange-600 text-white font-bold text-base sm:text-lg px-8 py-3.5 rounded-full hover:bg-orange-500 transition-all transform hover:scale-105 hover:shadow-[0_0_20px_rgba(249,115,22,0.5)] ring-2 ring-orange-600 ring-offset-2 ring-offset-black"
              >
