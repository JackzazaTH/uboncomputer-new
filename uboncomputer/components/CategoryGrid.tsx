            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 md:grid-cols-5 lg:grid-cols-7 gap-4">
                    {categories.map((category) => {
                        const commonClasses = "bg-white rounded-lg p-4 flex items-center space-x-3 shadow-sm hover:shadow-md hover:border-orange-400 border border-transparent hover:-translate-y-1 transition-all duration-300 w-full text-left";
