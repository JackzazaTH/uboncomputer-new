      ...
      <div className="container mx-auto px-4 sm:px-6 2xl:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          <div className="flex items-center space-x-1 sm:space-x-2">
            {/* Mobile Search Icon */}
            <button className="2xl:hidden p-2 rounded-full text-gray-700 hover:bg-gray-100 transition-colors" onClick={() => setIsSearchOpen(true)}>
                <Search className="w-6 h-6" />
            </button>
            {/* Desktop User Icon */}
            <button onClick={onAuthClick} className="hidden 2xl:flex p-2 rounded-full text-gray-700 hover:bg-gray-100 transition-colors">
              <User className="w-6 h-6" />
            </button>
            <button onClick={() => onNavigate('compare')} className="hidden 2xl:flex relative p-2 rounded-full text-gray-700 hover:bg-gray-100 transition-colors">
            ...
            <button onClick={() => onNavigate('cart')} className="hidden 2xl:flex relative p-2 rounded-full text-gray-700 hover:bg-gray-100 transition-colors">
             ...
             <button className="2xl:hidden text-gray-800" onClick={() => setIsMobileMenuOpen(!isMobileMenuOpen)}>
      ...
      <div className="border-t border-gray-200">
       ...
       {isMobileMenuOpen && (
        <>
          ...
          <div 
            className="2xl:hidden fixed top-0 left-0 h-full w-72 bg-white shadow-lg z-50 transform transition-transform duration-300 ease-in-out"
