    ...
    <section className="py-8 sm:py-12 -mt-6 sm:-mt-16 relative z-20">
      <div className="container mx-auto px-4 sm:px-6 2xl:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6">
          {banners.map((promo) => (
            <a href={promo.link} key={promo.id} className="block rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-500 group transform hover:-translate-y-1 border-4 border-white/50 hover:border-white/80 backdrop-blur-md">
