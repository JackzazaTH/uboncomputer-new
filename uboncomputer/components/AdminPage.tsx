  ...
  return (
    <div className="min-h-screen bg-gray-100 flex font-sarabun">
      ...
      <div className="lg:ml-72 flex-grow flex flex-col min-h-screen">
          {/* Mobile Header */}
          <header className="bg-white border-b p-4 lg:hidden flex justify-between items-center sticky top-0 z-10 shadow-sm">
          ...
          <main className="p-4 sm:p-8 lg:p-10 flex-grow max-w-screen-2xl mx-auto w-full">
            ...
            {activeTab === 'users' && (
                <div className="bg-white rounded-xl shadow-sm border p-12 text-center text-gray-500">
                    ...
                    <h3 className="text-xl font-bold text-gray-700">ส่วนจัดการผู้ใช้งาน</h3>
