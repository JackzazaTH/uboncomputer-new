...
const ComparisonTray: React.FC<ComparisonTrayProps> = ({ onNavigate }) => {
    ...
    return (
        <div className="fixed bottom-0 left-0 right-0 bg-white text-gray-800 shadow-[0_-4px_15px_rgba(0,0,0,0.1)] z-40 animate-slide-in-up 2xl:pb-0 pb-16 border-t border-gray-200">
                        ...
                        <div className="flex items-center gap-3 overflow-x-auto">
                            {compareItems.map(item => (
                                <div key={item.id} className="relative group flex-shrink-0">
                                    ...
                                    <img src={item.imageUrls[0]} alt={item.name} className="w-16 h-16 object-contain bg-white rounded-md p-1 border"/>
                                    <button 
