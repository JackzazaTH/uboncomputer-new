...
const ReviewSection: React.FC<{ product: Product; onSaveReview: ProductPageProps['onSaveReview'] }> = ({ product, onSaveReview }) => {
          ...
          <div className="bg-gray-50 p-6 rounded-lg sticky top-28 border">
            ...
            <form onSubmit={handleReviewSubmit} className="space-y-4">
              <div>
                ...
                <input type="text" id="author" value={newReview.author} onChange={e => setNewReview({...newReview, author: e.target.value})} required className="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-orange-500 focus:border-orange-500" />
              </div>
              <div>
              ...
              <div>
                ...
                <textarea id="comment" rows={4} value={newReview.comment} onChange={e => setNewReview({...newReview, comment: e.target.value})} required className="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-orange-500 focus:border-orange-500" />
              </div>
...
const ProductPage: React.FC<ProductPageProps> = ({ product, allProducts, onNavigate, onSaveReview }) => {
  ...
  return (
    <div className="bg-white">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <ReviewSection product={product} onSaveReview={onSaveReview} />
