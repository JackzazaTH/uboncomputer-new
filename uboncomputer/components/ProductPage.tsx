          ...
          <div>
            <nav className="text-sm mb-4" aria-label="Breadcrumb">
              <ol className="list-none p-0 inline-flex">
                ...
                <li className="flex items-center">
                  <a href="#" onClick={(e) => { e.preventDefault(); onNavigate(product.category.toLowerCase() as any); }} className="text-gray-800 font-semibold hover:text-orange-600">{product.category}</a>
                </li>
              </ol>
            </nav>
