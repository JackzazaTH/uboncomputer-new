...
const SearchOverlay: React.FC<SearchOverlayProps> = ({ isOpen, onClose, onNavigate, allProducts, onSearchSubmit }) => {
    ...
    >
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 h-full">
        <div className="flex flex-col h-full">
          <form onSubmit={handleSearchSubmit} className="flex items-center h-20 border-b">
