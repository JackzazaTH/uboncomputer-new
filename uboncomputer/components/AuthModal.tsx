...
const AuthModal: React.FC<AuthModalProps> = ({ onClose, onForgotPasswordClick }) => {
            ...
            {activeTab === 'login' ? (
              <form className="space-y-5" onSubmit={handleLoginSubmit}>
                ...
                <div className="text-right">
                  <button type="button" onClick={onForgotPasswordClick} className="text-sm text-orange-600 hover:underline">ลืมรหัสผ่าน?</button>
                </div>
