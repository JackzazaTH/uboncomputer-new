...
export const mockProducts: Product[] = [
  ...
  { id: 4, name: 'AMD Radeon RX 7900 XTX', category: 'GPU', price: 42000, costPrice: 38500, stock: 0, availability: 'byOrder', imageUrls: ['https://picsum.photos/seed/gpu2/400/400'], rating: 4.7, reviewCount: 150, brand: 'AMD', description: 'Built on the groundbreaking AMD RDNA™ 3 architecture with chiplet technology, the Radeon™ RX 7900 XTX graphics delivers next-generation performance, visuals, and efficiency at 4K and beyond.' },
  { id: 5, name: 'Corsair Vengeance RGB 32GB DDR5', category: 'RAM', price: 4990, oldPrice: 5500, costPrice: 4800, stock: 150, availability: 'inStock', imageUrls: ['https://picsum.photos/seed/ram1/400/400'], rating: 4.9, reviewCount: 180, brand: 'Corsair', specs: { ramType: 'DDR5' }, description: 'Push the limits of your system like never before with DDR5 memory, unlocking even faster frequencies, greater capacities, and better performance, illuminated by dynamic ten-zone RGB lighting.' },
  { id: 6, name: 'G.Skill Trident Z5 RGB 32GB DDR5', category: 'RAM', price: 5800, costPrice: 5100, stock: 120, availability: 'inStock', imageUrls: ['https://picsum.photos/seed/ram2/400/400'], rating: 4.9, reviewCount: 165, brand: 'G.Skill', specs: { ramType: 'DDR5' }, description: 'Trident Z5 RGB series DDR5 memory is the latest G.SKILL flagship series designed for ultra-high extreme performance on next-gen DDR5 platforms.' },
  { id: 7, name: 'ASUS ROG MAXIMUS Z790 HERO', category: 'Motherboard', price: 25000, costPrice: 22500, stock: 40, availability: 'inStock', imageUrls: ['https://picsum.photos/seed/mobo1/400/400'], rating: 5, reviewCount: 88, brand: 'ASUS', specs: { socket: 'LGA1700', ramType: 'DDR5' }, description: 'A motherboard built for enthusiasts, offering robust power delivery, comprehensive cooling, and cutting-edge connectivity for the latest Intel processors.' },
  { id: 8, name: 'MSI MPG X670E CARBON WIFI', category: 'Motherboard', price: 17990, oldPrice: 18500, costPrice: 16800, stock: 35, availability: 'inStock', imageUrls: ['https://picsum.photos/seed/mobo2/400/400'], rating: 4.8, reviewCount: 75, brand: 'MSI', specs: { socket: 'AM5', ramType: 'DDR5' }, description: 'A premium motherboard for AMD Ryzen 7000 series processors, featuring a stylish carbon-black design, powerful VRM, and extensive connectivity options including Wi-Fi 6E.' },
  { id: 9, name: 'Samsung 980 Pro 2TB NVMe SSD', category: 'Storage', price: 7200, costPrice: 6500, stock: 200, availability: 'inStock', imageUrls: ['https://picsum.photos/seed/ssd1/400/400'], rating: 5, reviewCount: 300, brand: 'Samsung', description: 'Unleash the power of the Samsung PCIe 4.0 NVMe SSD 980 PRO for your next-level computing. Leveraging the PCIe 4.0 interface, the 980 PRO delivers double the data transfer rate of PCIe 3.0.' },
  { id: 10, name: 'Western Digital Black SN850X 2TB', category: 'Storage', price: 6500, oldPrice: 6900, costPrice: 6200, stock: 180, availability: 'inStock', imageUrls: ['https://picsum.photos/seed/ssd2/400/400'], rating: 4.9, reviewCount: 250, brand: 'WD', description: 'The WD_BLACK™ SN850X NVMe™ SSD enables you to amp up your game with ludicrously fast read and write speeds. Get the ultimate gaming edge.' },
  { id: 11, name: 'Lian Li PC-O11 Dynamic EVO', category: 'Case', price: 5600, costPrice: 4900, stock: 0, availability: 'outOfStock', imageUrls: ['https://picsum.photos/seed/case1/400/400'], rating: 5, reviewCount: 210, brand: 'Lian Li', description: 'A highly modular case that offers multiple configurations, stunning aesthetics with dual tempered glass panels, and exceptional cooling potential.' },
  { id: 12, name: 'NZXT H5 Flow', category: 'Case', price: 3200, costPrice: 2800, stock: 100, availability: 'inStock', imageUrls: ['https://picsum.photos/seed/case2/400/400'], rating: 4.7, reviewCount: 140, brand: 'NZXT', description: 'A compact mid-tower case with a focus on optimal airflow. Its perforated front panel provides excellent cooling for high-performance components.' },
  { id: 13, name: 'Noctua NH-D15 chromax.black', category: 'Cooling', price: 3990, oldPrice: 4200, costPrice: 3700, stock: 90, availability: 'inStock', imageUrls: ['https://picsum.photos/seed/cooler1/400/400'], rating: 5, reviewCount: 450, brand: 'Noctua', description: 'The legendary NH-D15, now in an all-black design. A dual-tower CPU cooler renowned for its quiet operation and cooling performance that rivals many all-in-one liquid coolers.' },
  { id: 14, name: 'Corsair iCUE H150i ELITE CAPELLIX XT', category: 'Cooling', price: 7800, costPrice: 7000, stock: 60, availability: 'inStock', imageUrls: ['https://picsum.photos/seed/cooler2/400/400'], rating: 4.8, reviewCount: 190, brand: 'Corsair', description: 'A high-performance 360mm all-in-one liquid CPU cooler, featuring ultra-bright CAPELLIX LEDs, powerful AF RGB ELITE fans, and iCUE software control.' },
  { id: 15, name: 'Intel Core i5-13600K', category: 'CPU', price: 12500, costPrice: 11000, stock: 75, availability: 'inStock', imageUrls: ['https://picsum.photos/seed/cpu3/400/400'], rating: 4.9, reviewCount: 215, brand: 'Intel', specs: { socket: 'LGA1700' }, description: 'The sweet spot for high-performance gaming. The Core i5-13600K offers an excellent balance of core count, clock speed, and price for gamers and mainstream users.' },
  { id: 16, name: 'NVIDIA GeForce RTX 4070 Ti', category: 'GPU', price: 35000, costPrice: 31500, stock: 25, availability: 'inStock', imageUrls: ['https://picsum.photos/seed/gpu3/400/400'], rating: 4.8, reviewCount: 180, brand: 'NVIDIA', description: 'Get equipped for stellar gaming and creating with the NVIDIA® GeForce RTX™ 4070 Ti. It’s built with the ultra-efficient NVIDIA Ada Lovelace architecture.' },
  { id: 17, name: 'Crucial P5 Plus 1TB NVMe SSD', category: 'Storage', price: 3590, oldPrice: 3800, costPrice: 3400, stock: 250, availability: 'inStock', imageUrls: ['https://picsum.photos/seed/ssd3/400/400'], rating: 4.8, reviewCount: 200, brand: 'Crucial', description: 'With lightning-fast speeds and a 1TB capacity, the Crucial P5 Plus provides the performance needed for hardcore gamers and professionals.' },
  ...
  { id: 19, name: 'Kingston FURY Beast 16GB DDR4', category: 'RAM', price: 1990, oldPrice: 2100, costPrice: 1800, stock: 300, availability: 'inStock', imageUrls: ['https://picsum.photos/seed/ram3/400/400'], rating: 4.7, reviewCount: 350, brand: 'Kingston', specs: { ramType: 'DDR4' }, description: 'Kingston FURY™ Beast DDR4 provides a powerful performance boost for gaming, video editing, and rendering with speeds up to 3733MHz.' },
  { id: 20, name: 'Cooler Master MasterBox TD500 Mesh', category: 'Case', price: 3500, costPrice: 3000, stock: 95, availability: 'inStock', imageUrls: ['https://picsum.photos/seed/case3/400/400'], rating: 4.8, reviewCount: 190, brand: 'Cooler Master', description: 'A high-airflow case featuring a polygonal mesh front panel, crystalline tempered glass side panel, and three pre-installed ARGB fans for stunning aesthetics and performance.' },
  ...
  { id: 801, name: 'ASUS ROG Strix G16CH', category: 'Pre-built PC', price: 79990, costPrice: 72000, stock: 10, availability: 'inStock', imageUrls: ['https://www.img.in.th/images/9c1ed367d3e18a09b43c68383a17e082.png'], rating: 4.9, reviewCount: 40, brand: 'ASUS', description: 'Intel Core i7-13700F / GeForce RTX 4070 / 16GB DDR4 / 1TB SSD', specs: {} },
  { id: 802, name: 'MSI MPG Trident AS 13th', category: 'Pre-built PC', price: 65900, oldPrice: 69900, costPrice: 60000, stock: 12, availability: 'inStock', imageUrls: ['https://www.img.in.th/images/ca6d910f5e1f021e1d0981e4b85c1569.png'], rating: 4.8, reviewCount: 35, brand: 'MSI', description: 'Intel Core i7-13700F / GeForce RTX 4060 Ti / 16GB DDR5 / 1TB SSD', specs: {} },
  ...
  { id: 904, name: 'CORSAIR MOUSEPAD MM700 RGB EXTENDED', category: 'Gaming Gear', price: 2190, costPrice: 1900, stock: 100, availability: 'inStock', imageUrls: ['https://picsum.photos/seed/mousepad1/400/400'], rating: 4.6, reviewCount: 80, brand: 'Corsair', description: 'Extended cloth gaming mousepad with dynamic three-zone RGB lighting and a built-in two-port USB hub.' },
];
