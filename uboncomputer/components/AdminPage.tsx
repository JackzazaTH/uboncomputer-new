...
import { LogOut, ShoppingCart, Tv, Newspaper, Image as ImageIcon, PlusCircle, Edit, Trash2, X, ChevronDown, ChevronUp, Globe, Home, Search, LayoutGrid, Percent, Menu, Package, Briefcase, Save, Users, TrendingUp, Coffee, ToggleLeft, ToggleRight, Gamepad2 } from 'lucide-react';
            ...
            <div className="space-y-6">
                ...
                <div className="flex justify-end">
                    <div className="w-full md:w-1/2 lg:w-1/3 space-y-2">
                        ...
                        <div className="flex justify-between"><span className="text-red-600">ส่วนลด:</span> <span className="text-red-600">- {formatCurrency(order.discount)}</span></div>
