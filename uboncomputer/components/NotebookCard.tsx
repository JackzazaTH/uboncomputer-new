...
const NotebookCard: React.FC<NotebookCardProps> = ({ product, onNavigate }) => {
  ...
  return (
    <div 
      className="bg-white rounded-lg overflow-hidden flex flex-col group border border-gray-200 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 h-full p-4 relative cursor-pointer"
