    ...
    <div className="bg-white py-12">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
        ...
        <div className="prose lg:prose-lg max-w-none text-gray-800 leading-relaxed">
          ...
          <p>
            หลังจากที่คำสั่งซื้อของท่านได้รับการจัดส่งแล้ว ท่านจะได้รับอีเมลยืนยันพร้อมหมายเลขพัสดุ (Tracking Number) ซึ่งท่านสามารถนำไปตรวจสอบสถานะได้ที่หน้า <Link href="/order-status" className="text-orange-600 hover:underline font-semibold">"ตรวจสอบสถานะคำสั่งซื้อ"</Link> หรือผ่านทางเว็บไซต์ของบริษัทขนส่งโดยตรง
          </p>
