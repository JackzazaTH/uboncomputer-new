...
import { Product, Category, Article, ComputerSetGroup, HeroSlide, Page, SeoData, SeoEditablePage, Brand, DisplayProduct, HomepageContent, ProductCategory, AllCategoryPageData, DiscountCode, AdminOrder, CareersPageContent } from './types';
  ...
  return (
    <>
      ...
      <div className={`bg-gray-50 min-h-screen flex flex-col pb-16 lg:pb-0 transition-opacity duration-500 ${isHidingLoader || !isLoading ? 'opacity-100' : 'opacity-0'}`}>
        ...
        <Footer onAdminLoginClick={() => setIsLoginModalOpen(true)} onNavigate={navigateTo} />
