...
const ProductCard: React.FC<ProductCardProps> = ({ product }) => {
  ...
  return (
    <Link 
      ...
      className="bg-white rounded-lg overflow-hidden flex flex-col group border border-gray-200 hover:border-orange-500 hover:shadow-lg transition-all duration-300 relative"
    >
      {hasDiscount && (
