...
// Also import LogEntry and LogLevel for the new logging functionality.
...
const App: React.FC = () => {
  ...
  const addLog = (level: LogLevel, message: string) => {
    ...
    setLogs(prev => {
      const newLogs = [newLog, ...prev].slice(0, 200); // keep 200 logs
  ...
  const renderPage = () => {
    ...
    switch (currentPage) {
      case 'home': return (<> <Hero slides={heroSlides} /> <div className="animate-slide-in-up" style={{ animationDelay: '0ms' }}><PromoBanners banners={homepageContent.promoBanners} /></div> <div className="animate-slide-in-up" style={{ animationDelay: '100ms' }}><IntroSection content={homepageContent.introSection} /></div> <section className="py-12 animate-slide-in-up" style={{ animationDelay: '200ms' }}> <div className="container mx-auto px-4 sm:px-6 2xl:px-8"> <DualPromoCarousel carousels={homepageContent.dualCarousels} /> <StoreInfo content={homepageContent.storeInfo} /> </div> </section> <div className="animate-slide-in-up" style={{ animationDelay: '300ms' }}><CategoryGrid onNavigate={navigateTo} /></div> <div className="animate-slide-in-up" style={{ animationDelay: '0ms' }}><MainPromoBanner banner={homepageContent.mainPromoBanner} /></div> <div className="animate-slide-in-up" style={{ animationDelay: '100ms' }}><ProductDisplaySection viewAllPage="allProducts" onNavigate={navigateTo} title={homepageContent.sectionTitles.newProducts} products={homepageContent.newProducts} brands={[]} sidebarTitle="สินค้าใหม่" /></div> <div className="animate-slide-in-up" style={{ animationDelay: '200ms' }}><ProductDisplaySection onNavigate={navigateTo} title={homepageContent.sectionTitles.notebooks} products={homepageContent.notebooks} brands={homepageContent.notebookBrands} sidebarTitle="โน้ตบุ๊ค" /></div> <div className="animate-slide-in-up" style={{ animationDelay: '300ms' }}><ProductDisplaySection onNavigate={navigateTo} title={homepageContent.sectionTitles.computers} products={homepageContent.computers} brands={homepageContent.computerBrands} sidebarTitle="คอมพิวเตอร์" /></div> <div className="animate-slide-in-up" style={{ animationDelay: '400ms' }}><ProductDisplaySection onNavigate={navigateTo} title={homepageContent.sectionTitles.printers} products={homepageContent.printers} brands={homepageContent.printerBrands} sidebarTitle="ปริ้นเตอร์" /></div> <div className="animate-slide-in-up" style={{ animationDelay: '500ms' }}><ProductDisplaySection onNavigate={navigateTo} title={homepageContent.sectionTitles.preBuiltPCs} products={homepageContent.preBuiltPCs} brands={homepageContent.preBuiltPCBrands} sidebarTitle="คอมประกอบ" /></div> <div className="animate-slide-in-up" style={{ animationDelay: '600ms' }}><YoutubeSection title={homepageContent.sectionTitles.youtube} videos={homepageContent.youtube.videos} /></div> <div className="animate-slide-in-up" style={{ animationDelay: '700ms' }}><ArticleSection onNavigate={navigateTo} articles={articles} title={homepageContent.sectionTitles.articles} /></div> <div className="animate-slide-in-up" style={{ animationDelay: '800ms' }}><InfoBar items={homepageContent.infoBar.items} /></div> </>);
  ...
  if (currentPage === 'admin' && isAdmin) {
     return (<> {isLoading && <LoadingScreen isHiding={isHidingLoader} />} <div className={`transition-opacity duration-500 ${isHidingLoader || !isLoading ? 'opacity-100' : 'opacity-0'}`}> {renderPage()} </div> </>);
  }

  return (
    <>
      {isLoading && <LoadingScreen isHiding={isHidingLoader} />}
      <div className={`bg-slate-50 dark:bg-gray-900 min-h-screen flex flex-col pb-20 2xl:pb-0 transition-opacity duration-500 ${isHidingLoader || !isLoading ? 'opacity-100' : 'opacity-0'}`}>
        <Header 
