...
export default function Category({ params }: { params: { category: string } }) {
  const { products, categoryPageData, seoData, onNavigate } = useAppContext();
  ...
  return <CategoryPage allProducts={products} categoryConfig={categoryConfig} bannerUrl={pageData.bannerUrl} onNavigate={onNavigate} />;
}