...
const ArticleCard: React.FC<ArticleCardProps> = ({ article, onNavigate }) => {
    return (
        <div 
            ...
            className="bg-white rounded-xl overflow-hidden shadow-md hover:shadow-2xl hover:-translate-y-1 transition-all duration-300 flex flex-col group cursor-pointer"
        >
            <div className="relative overflow-hidden">
                <img src={article.imageUrls[0]} alt={article.title} className="w-full h-56 object-cover group-hover:scale-105 transition-transform duration-300" />
