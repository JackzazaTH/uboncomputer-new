...
const ComputerSetPage: React.FC<ComputerSetPageProps> = ({ groups }) => {
    ...
    <div className="bg-white">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <section className="text-center mb-8">
            ...
            <Link href="/pc-builder" className="mt-4 inline-block bg-red-600 text-white font-bold py-2 px-6 rounded-md hover:bg-red-700 transition-colors">
