                ...
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="bg-gray-800 text-white rounded-lg p-12 text-center">
                        ...
                        <div className="flex flex-col sm:flex-row justify-center gap-4">
                            <button onClick={() => router.push('/contact')} className="inline-flex items-center justify-center bg-orange-500 hover:bg-orange-600 text-white font-bold py-3 px-8 rounded-md transition-colors">
                                ติดต่อเรา
                                <ChevronRight className="w-5 h-5 ml-2" />
                            </button>
                            <button onClick={() => router.push('/')} className="inline-flex items-center justify-center bg-gray-700 hover:bg-gray-600 text-white font-bold py-3 px-8 rounded-md transition-colors">
                                กลับไปหน้าแรก
                            </button>
                        </div>
                    </div>
