...
const NotebookCard: React.FC<NotebookCardProps> = ({ product, onNavigate }) => {
  ...
  return (
    <div 
      className="bg-white rounded-lg overflow-hidden flex flex-col group border border-gray-200 hover:border-orange-300 hover:shadow-xl hover:-translate-y-1 hover:scale-[1.02] transition-all duration-300 h-full p-4 relative cursor-pointer"
