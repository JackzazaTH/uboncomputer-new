...
export const categoryConfigurations: Record<ProductCategory, CategoryConfig> = {
    ...
    gamingGear: {
        name: 'Gaming Gear',
        title: 'Gaming Gear / อุปกรณ์เกมมิ่ง',
        internalCat: 'Gaming Gear',
        filters: [
            { key: 'brand', label: 'แบรนด์' },
        ],
    },
    // FIX: Added missing properties to satisfy the Record<ProductCategory, CategoryConfig> type.
    desktopComputer: {
        name: 'Desktop Computer',
        title: 'Desktop Computer / คอมพิวเตอร์ตั้งโต๊ะ',
        internalCat: 'Desktop Computer',
        filters: [
            { key: 'brand', label: 'แบรนด์' },
        ],
    },
    aioComputer: {
        name: 'All-in-one PC',
        title: 'All-in-one PC / คอมพิวเตอร์ AIO',
        internalCat: 'All-in-one PC',
        filters: [
            { key: 'brand', label: 'แบรนด์' },
        ],
    },
