...
export type Page = 'home' | 'pcBuilder' | 'computerSet' | 'articles' | 'contact' | 'about' | 'admin' | 'cart' | 'promotions' | 'articleDetail' | 'productDetail' | 'corporate' | 'faq' | 'orderStatus' | 'searchResults' | 'privacy' | 'terms' | 'cookies' | 'shipping' | 'returns' | 'careers' | 'checkout' | 'compare' | 'computerSetDetail' | 'allProducts' | 'reviews' | ProductCategory;
