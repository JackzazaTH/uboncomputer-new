...
const ComputerSetDetailPage: React.FC<ComputerSetDetailPageProps> = ({ product, relatedProducts, onNavigate }) => {
    ...
    const specItemsToRender = Object.entries(product.specs)
    ...
    const handleAddToCart = () => {
        const specStringForDesc = specItemsToRender.map(item => item.value).join(', ');
            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                    ...
                    <div>
                        ...
                        <div className="mb-6">
                            <h2 className="text-xl font-bold text-gray-800 mb-4">สเปคเครื่อง</h2>
                            <div className="space-y-4">
                                {specItemsToRender.map((item) => (
                                    <div key={item.key} className="border-b border-gray-200 pb-3">
                                        <p className="text-sm font-semibold uppercase text-gray-500">{item.key}</p>
