...
import { Page, DiscountCode, User, LogLevel } from '../types';
...
const CheckoutPage: React.FC<CheckoutPageProps> = ({ onNavigate, discountCodes, addLog, currentUser }) => {
    ...
    const handlePlaceOrder = () => {
        ...
        const userIdentifier = currentUser ? `${currentUser.name} (${currentUser.email})` : 'Guest';
        addLog('SUCCESS', `User ${userIdentifier} placed a new order with a total of ${formatCurrency(grandTotal)}.`);
        clearCart();
        onNavigate('home');
    };
        ...
        <div className="bg-gray-50">
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
                ...
                <div className="grid grid-cols-1 2xl:grid-cols-3 gap-8 items-start">
                    ...
                    {/* Billing & Payment */}
                    <div className="2xl:col-span-2 bg-white p-6 rounded-lg shadow-sm border border-gray-200 space-y-8">
                        <div>
