...
const ComputerSetCard: React.FC<ComputerSetCardProps> = ({ product, onNavigate }) => {
  ...
  return (
    <button
      ...
      className="bg-white rounded-2xl overflow-hidden flex flex-col group border border-gray-100 hover:border-orange-300 hover:shadow-xl hover:scale-[1.02] transition-all duration-300 h-full text-left w-full relative transform hover:-translate-y-1 shadow-sm"
    >
