            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
                ...
                {featuredArticle && (
                    <section className="mb-12 group">
                        <div 
                            onClick={() => onNavigate('articleDetail', { articleId: featuredArticle.id })} 
                            className="cursor-pointer block 2xl:flex gap-8 bg-white p-6 rounded-xl shadow-lg hover:shadow-2xl transition-shadow duration-300"
                        >
                            <div className="2xl:w-1/2 overflow-hidden rounded-lg">
                                <img 
                                    src={featuredArticle.imageUrls[0]} 
                                    alt={featuredArticle.title}
                                    className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500"
                                />
                            </div>
                            <div className="2xl:w-1/2 mt-6 2xl:mt-0 flex flex-col justify-center">
