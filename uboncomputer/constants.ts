import { Product, Category, ComputerSetGroup, Article, HeroSlide, SeoData, Brand, DisplayProduct, HomepageContent, AllCategoryPageData, Order, DiscountCode } from './types';
...
export const mockSeoData: SeoData = {
  ...
  motherboard: {
    ...
    description: "เลือกซื้อเมนบอร์ดสำหรับ Intel และ AMD ทุกซ็อกเก็ต รองรับ CPU รุ่นใหม่ล่าสุด"
  },
  storage: {
