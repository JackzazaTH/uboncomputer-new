...
export const mockProducts: Product[] = [
  ...
  { id: 904, name: 'CORSAIR MOUSEPAD MM700 RGB EXTENDED', category: 'Gaming Gear', price: 2190, costPrice: 1900, stock: 100, availability: 'inStock', imageUrls: ['https://picsum.photos/seed/mousepad1/400/400'], rating: 4.6, reviewCount: 80, brand: 'Corsair', description: 'Extended cloth gaming mousepad with dynamic three-zone RGB lighting and a built-in two-port USB hub.', specs: { 'Size': 'Extended' }, notes: '' },
];
